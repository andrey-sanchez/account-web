...
public class RecreateDbRoute implements Route {
  ...
  public RecreateDbRoute(final Jdbi jdbi) {
    ...
    jdbi.useHandle(handler -> {
      ...
      handler.execute("CREATE TABLE transaction (id NVARCHAR(32) NOT NULL PRIMARY KEY, owner_account_id NVARCHAR(64) NOT NULL, timestamp bigint NOT NULL, type VARCHAR(16) NOT NULL)");
    });
